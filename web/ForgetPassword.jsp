<html>
    ...
    <center>
        <br>
      <h3> You Can Set Your New Password Here</h3>
        <br><br>
        <form action="ForgetPasswordDBMS.jsp" method='post' style="position:static;  
                                                          margin-top: 5%; 
                                                          margin-left: 15%;
                                                          margin-right: 13%;
            ...
            <table align="center">
                <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                    <td style="width: 50%">Enter LoginID</td>
                ...
                <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                    <td style="width: 50%">Select Security Question</td>
                    <td style="width: 50%"><Select name="secques">
                ...
                <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                    <td style="width: 50%">Enter Security Answer</td>
                ...
                <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                    <td style="width: 50%">Enter New Password</td>
                    <td style="width: 50%"><input type='text' name='newpass'></td>
                </tr>
                <tr style="width: 80%;
                           margin: 10%;
                           padding: 5%;
                    ...
                    <td style="width: 50%"><input type='text' name='cnpass'></td>
                </tr>
                <tr style="width: 80%;
                           margin: 10%;
                           padding: 5%;
                           font-size: 20px;">
                    <td style="width: 50%"><input type="submit" name='b1' value="Update"></td>
                </tr>
