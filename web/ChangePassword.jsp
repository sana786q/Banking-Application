<html>
    ...
    <body bgcolor='skyblue' style="display: static;
            align-items: center;
    ...
    <center> <b>    Welcome <%=session.getAttribute("login_id")%>
        <br><br>
      you change your password please enter the following Detail's</b> </center> 
        <br>
        <form action="ChangePasswordDBMS.jsp" method='post' style="position:static;  
                                                          margin-top: 5%; 
                                                          margin-left: 20%;
                                                          margin-right: 13%;
                                                          ...
                                                          margin-bottom: 40vh;">
          <b>  Enter Old Password :<input type='text' name='oldpass'><br><br>
            Enter New Password :<input type='text' name='newpass'><br><br>
            Confirm Password :</b><input type='text' name='cnpass'><br><br>
            
          <button type="button" class="btn btn-info p-1 " aria-expanded="false">
                 <b>    UPDATE</b>
                    </button>
        </form>
    </body>
