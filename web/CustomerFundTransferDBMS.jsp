    ...
    <body style="display: static;
        ...
        <%
            try
            {
                ...
                String depositequery="insert into "+session.getAttribute("login_id")+" values(?,?,?,?,?,?,?)";
			...
			if (t < 4)
                ...
                out.println("<br>"+answer+"Cash Transfered Successfully....From "+refname+" TABLE<br>");
                ...
                pst2.executeUpdate();
                out.println("<br>"+answer+"Cash Credited Successfully....In "+accno+" TABLE");
