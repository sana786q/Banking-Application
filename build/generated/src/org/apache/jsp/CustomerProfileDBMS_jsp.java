...
public final class CustomerProfileDBMS_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Connection con;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        ");
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                out.println("<br><br>");
                out.println("Fathers Name ::"+rs.getString(3));
                out.println("<br><br>");
                ...
                out.println("<br><br>");
                out.println("Contact Number :: "+rs.getInt(8));
                out.println("<br><br>");
                out.println("Role ::"+rs.getString(9));
                out.println("<br><br>");
                out.println("Password ::"+rs.getString(10));
                out.println("<br><br>");
                out.println("Security Ques ::"+rs.getString(11));
                out.println("<br><br>");
                out.println("Security Ans ::"+rs.getString(12));
      ...
      out.write("\n");
      out.write("        <br><br>\n");
      out.write("        <a href=\"UpdateCustomer.jsp\"><input type=\"submit\" name=\"b1\" value=\"UPDATE PROFILE\"></a>\n");
      out.write("    </center>  \n");
      out.write("    </body>\n");
      out.write("</html>");
    } catch (Throwable t) {
