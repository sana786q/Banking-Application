...
<html>
    ...
    <body bgcolor="skyblue" style="display: static;
        ...
        <h3>
            <center>
                <form action="CashWithdrawDBMS.jsp" method="post" style="position:static;  
                                                          margin-top: 5%; 
                                                          margin-left: 15%;
                                                          margin-right: 13%;
                ...
                <table align="center">
                    ...
                    <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                        <td style="width: 50%">Withdraw Amount</td>
                        <td style="width: 50%"><input type="text" name="wthamt"></td>
                    </tr>
                    <tr></tr>
                    <tr style="width: 80%;
                           margin: 10%;
                           padding: 5%;
                           font-size: 20px;">
                        <td style="width: 50%"><input type="submit" name="b1" value="Withdraw"</td>
