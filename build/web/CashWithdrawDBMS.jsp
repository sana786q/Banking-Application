        ...
        <%
			...
			if (t < 4)
				answer += (multiplier[(int)++t] + " ");
                 ...
                 out.println("<br>"+answer+" cash withdrawl Successfull FOR TRANSACTIONABNK TABLE<br>");
                 //---------------------FOR CUSTOMER ----------------
                ...
                pst3.executeUpdate();
                 ...
                 out.println("<br>"+answer+" cash withdraw Successfull FOR CUSTOMER TABLE");
            }
            catch(Exception e)
            {
                out.println("cash withdraw Failed "+e);
            }
        %>
    </body>
</html>