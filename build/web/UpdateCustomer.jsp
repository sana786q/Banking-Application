<html>
    ...
    <body style="display: static;
        ...
        <form action="UpdateCustomerDBMS.jsp" method="post" style="position:static;  
                                                          margin-top: 5%; 
                                                          margin-left: 15%;
                                                          margin-right: 13%;
            ...
            Select the Field You want To Update
                <Select name="fields" >
                        ...
                        <option value="cusfname">Father Name</option>
                        <option value="dob">DOB</option>
                        <option value="gender">Gender</option>
                        <option value="address">Address</option>
                        <option value="contactno">Contact No.</option>
                        <option value="sques">Security Ques</option>
                        <option value="sans">Security Ans</option>
                        
                </Select><br><br>
            Enter the New Value<input type="text" name="value"><br><br>
            <input type="submit" name="b1" value="UPDATE PROFILE">
