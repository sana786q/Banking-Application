...
<html>
    ...
    <body bgcolor="skyblue" style="display: static;
        ...
        <h1 align="center">Customer Fund Transfer</h1>
        <h3>
            <center>
                 Welcome <%=session.getAttribute("login_id")%> <br><br>
                <form action="CustomerFundTransferDBMS.jsp" method="post" style="position:static;  
                                                          margin-top: 5%; 
                                                          margin-left: 15%;
                                                          margin-right: 13%;
                ...
                <table align="center">
                    ...
                    <tr style="width: 80%;
                        ...
                        <td style="width: 50%"><input type="text" name="refname" value="<%=session.getAttribute("login_id")%>"></td>
                    </tr>
                    <tr style="width: 80%;
                           margin: 10%;
                           padding: 5%;
                        ...
                        <td style="width: 50%"><input type="date" name="dot" value="<%=formatter.format(dt)%>"></td>
                    </tr>
                    <tr style="width: 80%;
                           margin: 10%;
                           padding: 5%;
