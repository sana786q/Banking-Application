...
<html>
    ...
    <body bgcolor="skyblue" style="display: static;
        ...
        <h3>
           <center>
            <form action="CashDepositeDBMS.jsp" method="post" style="position:static;  
                                                          margin-top: 5%; 
                                                          margin-left: 15%;
                                                          margin-right: 13%;
                ...
                <table align="center">
                    ...
                    <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                        <td style="width: 50%">Deposite Amount</td>
                    ...
                    <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                        <td style="width: 50%"><input type="submit" name="b1" value="Deposite"></td>
